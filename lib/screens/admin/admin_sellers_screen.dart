    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Definí la clave del portal (mínimo 10 letras/números). '
            'Los vendedores entran por URL con dominio + esta clave.',
          ...
          const Text(
            'En el inicio eligen “Entrar como vendedor”, ponen el dominio '
            'y la clave que definas acá.',
            style: TextStyle(
              fontSize: 13,
