-- Fix: stock_movimientos.venta_id es uuid; el RPC recibía text sin cast.
-- App-wide: mismo RPC para todos los tenants (World Guns, Urban, etc.).
-- Conserva el guard de tenant de 018; solo corrige el tipo al insertar movimientos.
