-- 044_tenant_member_tenant_param.sql
-- Permite pasar p_tenant_id explícito cuando el JWT no trae tenant_id
-- (p. ej. subdominio tenant con sesión sin active_tenant refrescado).
